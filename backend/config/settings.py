...
CORS_ALLOW_ALL_ORIGINS = DEBUG  # Solo in development; in produzione impostare CORS_ALLOWED_ORIGINS
if not DEBUG:
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        # TODO: cambiare in IsAuthenticated quando si implementa il login nel frontend
